...
var viewModel = function(map){
  ...
  self.flickrPhotoArray = ko.observableArray([]);
  ...
  */
  ...
  function getFlickrPhotos(){
    var url = 'https://api.flickr.com/services/rest/?method=flickr.photos.search&format=json&api_key='+FLICKR_KEY+'&lat='
    +'29.942656&lon=-90.070389&per_page=20&jsoncallback=?'


    $.getJSON(url, populateInfoWindow);
  }
  ...
  function populateInfoWindow(marker, id) {
    ...
    $.each(data.photos.photo, function(i, item) {
        ...
        self.flickrPhotoArray.push(newPhoto);
      })
    }
    ...
    service.getDetails({
      ...
      if (status === google.maps.places.PlacesServiceStatus.OK) {
        ...
        console.log(self.flickrPhotoArray[0]);
        self.flickrPhotoArray();
